  ...
  return (tree: Root) => {
    visit(tree, function (node) {
      if (
        ...
        const videoDirectiveRegex = createDirectiveRegex('video', image.alias)
        const linkDirectiveRegex = createDirectiveRegex('link', image.alias)
